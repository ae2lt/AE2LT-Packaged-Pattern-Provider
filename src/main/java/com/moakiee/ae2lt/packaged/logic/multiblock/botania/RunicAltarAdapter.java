...
public final class RunicAltarAdapter implements MultiblockAdapter {
    ...
    public boolean canDispatch(ServerLevel level, BlockPos mainPos, Object handle) {
        return canDispatch(level, mainPos, handle, AdapterPersistentScope.NOOP);
    }
    ...
    public boolean canDispatch(ServerLevel level, BlockPos mainPos, Object handle,
        ...
        boolean idle = inv != null && containerEmpty(inv);
        if (idle) {
            // An empty altar cannot still own the craft associated with this flag.
            // Clear it before a new dispatch so a player-completed craft cannot be harvested.
